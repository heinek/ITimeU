...
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_RaceIntermediate_Athlete]') AND parent_object_id = OBJECT_ID(N'[dbo].[RaceIntermediate]'))
ALTER TABLE [dbo].[RaceIntermediate] DROP CONSTRAINT [FK_RaceIntermediate_Athlete]
GO
...
/****** Object:  Table [dbo].[RaceIntermediate]    Script Date: 03/31/2011 09:20:37 ******/
